namespace SprayProcessSCADASystemOnWinform.UserControls {
    partial class UserCounterButton {
        ...
        private void InitializeComponent() {
            ...
            // btn_Counter
            // 
            btn_Counter.BackColor = Color.Transparent;
            btn_Counter.Dock = DockStyle.Fill;
            btn_Counter.Font = new Font("微软雅黑", 12F, FontStyle.Regular, GraphicsUnit.Point, 134);
            btn_Counter.Location = new Point(0, 0);
            btn_Counter.MinimumSize = new Size(1, 1);
            btn_Counter.Name = "btn_Counter";
            btn_Counter.Radius = 40;
            btn_Counter.Size = new Size(260, 130);
            btn_Counter.Symbol = 558653;
            btn_Counter.SymbolSize = 55;
            btn_Counter.TabIndex = 1;
            btn_Counter.Text = "空运行";
            btn_Counter.TipsFont = new Font("微软雅黑", 13F);
